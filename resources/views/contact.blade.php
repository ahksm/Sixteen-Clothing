        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div id="map">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d2862.6303685680923!2d69.19507310527213!3d41.20452741870195!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sru!2s!4v1678541802245!5m2!1sru!2s"
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <fieldset>
                                        ...
                                        <input name="name" type="text" class="form-control" id="name"
                                            placeholder="Full Name" required value="{{ old('message') }}">
                                    </fieldset>
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <fieldset>
                                        ...
                                        <input name="email" type="text" class="form-control" id="email"
                                            placeholder="E-Mail Address" required value="{{ old('message') }}">
                                    </fieldset>
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <fieldset>
                                        ...
                                        <input name="subject" type="text" class="form-control" id="subject"
                                            placeholder="Subject" required value="{{ old('message') }}">
                                    </fieldset>
                                </div>
                                <div class="col-lg-12">
                                    <fieldset>
